...
class AnnotationComparer:
    ...
    def create_violin_plots_single(self, annotator_scores, feature='Global', palette='colorblind'):
    ...
    def create_violin_plots(self, annotator_scores, features=['Global'], palette='colorblind'):
